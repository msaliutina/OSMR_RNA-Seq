...
hca7 <- read_excel('~/Desktop/Hegazy lab/bulk_rnaseq_2023/cell line data (OSM stimulation)/results_Voom_DEG_OSM_CRC.xlsx', 2)
...
res_epith <- read.csv('~/Desktop/Hegazy lab/bulk_rnaseq_2023/epith_degs.csv')

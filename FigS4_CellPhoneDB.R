...
means <- read.delim(file = "/Users/mariiasaliutina/Desktop/Hegazy lab/single_cell_2023/cellphonedb/out_ed_lpmc/Mouse_OSMR/means.txt", check.names = FALSE)
pvals <- read.delim(file = "/Users/mariiasaliutina/Desktop/Hegazy lab/single_cell_2023/cellphonedb/out_ed_lpmc/Mouse_OSMR/pvalues.txt", check.names = FALSE)
decon <- read.delim(file = '/Users/mariiasaliutina/Desktop/Hegazy lab/single_cell_2023/cellphonedb/out_ed_lpmc/Mouse_OSMR/deconvoluted.txt', check.names = FALSE)
